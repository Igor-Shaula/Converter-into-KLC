...
object Options {
    ...
    const val FILE = "f"
    const val LAYOUT = "l"
    const val KLC_RESULT_FILE_NAME = "-klc-f-name" // sample: "result_UTF-16.klc"
    const val KLC_LAYOUT_NAME_8 = "-klc-lo-name" // sample: "basic_EN"
    const val KLC_LAYOUT_DESCRIPTION = "-klc-lo-desc" // sample: "from X11 - English (US)"
    const val KLC_COPYRIGHT = "-klc-cr" // sample: = "(c) 2025 igor.shaula"
    const val KLC_COMPANY = "-klc-c" // sample: "Igor Shaula"
    const val KLC_LOCALE_NAME = "-klc-l-name" // sample: "en-US"
