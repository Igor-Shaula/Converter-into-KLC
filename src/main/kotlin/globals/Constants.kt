...
object Options {
    ...
    const val KLC_KBD_NAME_8 = "K_k8" // sample: "basic_EN"
    const val KLC_KBD_NAME_LONG = "K_kl" // sample: "from X11 - English (US)"
    const val KLC_COPYRIGHT = "K_cr" // sample: = "(c) 2025 igor.shaula"
    const val KLC_COMPANY = "K_c" // sample: "Igor Shaula"
    const val KLC_LOCALE_NAME = "K_l" // sample: "en-US"
    const val KLC_LOCALE_ID = "K_l-id" // sample: "00000409"
    const val KLC_VERSION = "K_v" // sample: "1.0"
    const val KLC_LANGUAGE = "K_lang" // sample: "English (United States)"
}