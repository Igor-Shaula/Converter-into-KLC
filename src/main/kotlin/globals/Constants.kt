...
object Options {
    ...
    const val VERSION = "v"
    const val SILENT = "s"
    const val SOURCE_X11_FILE = "f"
    const val SOURCE_X11_LAYOUT = "l"
    const val RESULT_KLC_FILE = "r" // sample: "result_UTF-16.klc"
    const val KLC_KBD_NAME_8 = "-klc-k8" // sample: "basic_EN"
    const val KLC_KBD_NAME_LONG = "-klc-kl" // sample: "from X11 - English (US)"
    const val KLC_COPYRIGHT = "-klc-cr" // sample: = "(c) 2025 igor.shaula"
    const val KLC_COMPANY = "-klc-c" // sample: "Igor Shaula"
    const val KLC_LOCALE_NAME = "-klc-l" // sample: "en-US"
    const val KLC_LOCALE_ID = "-klc-l-id" // sample: "00000409"
    const val KLC_VERSION = "-klc-v" // sample: "1.0"
    const val KLC_LANGUAGE = "-klc-lang" // sample: "English (United States)"
}